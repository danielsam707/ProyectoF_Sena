                        ...
                        <div class="custom_menu">
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownUsuario"
                                        role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Usuario
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownUsuario">
                                        <li><a class="dropdown-item"
                                                href="<?php echo getUrl('Usuario', 'Usuario', 'getInsert', false, false); ?>">Registrar</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo getUrl('Usuario', 'Usuario', 'consult', false, false); ?>">Consultar</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownTareas" role="button"
                                        data-bs-toggle="dropdown" aria-expanded="false">
                                        Tareas
                                    </a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownTareas">
                                        <li><a class="dropdown-item"
                                                href="<?php echo getUrl('Tareas', 'Tareas', 'getInsert', false, false); ?>">Registrar</a>
                                        </li>
                                        <li><a class="dropdown-item"
                                                href="<?php echo getUrl('Tareas', 'Tareas', 'consult', false, false); ?>">Consultar</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownPerfil">
                                            <li><a class="dropdown-item"
                                                    href="<?php echo getUrl('Acceso', 'Acceso', 'logout'); ?>">Cerrar
                                                    sesión</a></li>
                                        </ul>
                                    </li>
                                </ul>
